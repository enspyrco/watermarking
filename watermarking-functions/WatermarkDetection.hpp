...
#ifndef WatermarkDetection_hpp
#define WatermarkDetection_hpp
...
void extractMarkedImageDataWithSubtraction(cv::Mat& extracted_obj_img, cv::Mat& obj_img, double * marked_image_data);
